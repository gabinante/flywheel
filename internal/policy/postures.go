		...
		Rules: []Rule{
			{
				...
				Predicates: []Predicate{
					{Field: FieldTransition, Operator: OpIn, Values: []string{"claim", "start"}},
				},
				Action:  ActionAuto,
				Enabled: true,
			},
			...
			},
			{
				ID:          "sandbox-close",
				Name:        "close-approve",
				Description: "Closing requires human confirmation",
				Predicates: []Predicate{
					{Field: FieldTransition, Operator: OpIn, Values: []string{"close"}},
				},
				Action:  ActionApprove,
				Enabled: true,
			},
...
func PostureGraduatedRisk() PostureBundle {
	return PostureBundle{
		...
		Rules: []Rule{
			...
			{
				ID:          "gradrisk-close-prod-approve",
				Name:        "close-prod-approve",
				Description: "Production close always requires approval regardless of risk",
				Predicates: []Predicate{
					{Field: FieldEnvironment, Operator: OpEquals, Values: []string{"production"}},
					{Field: FieldTransition, Operator: OpEquals, Values: []string{"close"}},
				},
...
func PostureParanoidService() PostureBundle {
	return PostureBundle{
		...
		Rules: []Rule{
			...
			{
				ID:          "paranoid-critical-svc-close",
				Name:        "critical-services-close-confirm",
				Description: "Critical service close requires typed confirmation",
				Predicates: []Predicate{
					{Field: FieldService, Operator: OpMatches, Values: []string{"*-prod", "payments*", "auth*", "billing*"}},
					{Field: FieldTransition, Operator: OpEquals, Values: []string{"close"}},
				},
