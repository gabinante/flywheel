...
const navItems = [
  ...
  { path: '/merchants', label: 'Merchants', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
  ...
  { path: '/chargebacks', label: 'Chargebacks', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z' },
  ...
  { path: '/audit-log', label: 'Audit Log', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
];
      ...
      <aside className="w-64 bg-primary-700 text-white flex flex-col flex-shrink-0">
        <div className="p-4 border-b border-primary-600">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold">GoHighPayment</span>
          </div>
