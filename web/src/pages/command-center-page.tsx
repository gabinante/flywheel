  ...
  return (
    <div className="flex flex-col gap-4 max-w-7xl mx-auto animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(320px,1fr)_2fr]">
        {/* Left column: status + active work + activity */}
        ...
        <div className="min-h-[400px] rounded-xl border border-border bg-card/50 backdrop-blur-sm">
          {selectedTicketId ? (
            <TicketInspector
            ...
            <div className="flex h-full items-center justify-center p-8">
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-xs text-muted-foreground/60">
                  Click a ticket from the left panel or use j/k to navigate
                </p>
              </div>
            </div>
          )}
